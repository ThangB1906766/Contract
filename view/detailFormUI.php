                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="/controller/index.php?act=updateData2&id=<?=$hopdongId[0]['hd_id']?>" class="btn btn-primary">Tiến Hành Cập nhật</a>
                                        <a href="/controller/index.php?act=trove" class="btn btn-warning">Trở về</a>
